...
domString += `<p><span class='italic-text'>Project Description</span>: ${projects[i].description}</p>`;
domString += `<p><span class='italic-text'>Technologies Used</span>: ${projects[i].technologiesUsed}</p>`;
domString += `<footer>`;
